...
Zwei Rechner-Reste: T72 hat der Schiedsrichter der Runde 54 gefunden, T76 die Messung am gezogenen Wurf in Runde 56. Beide berühren Scores nur in Spielen mit einer betroffenen Art oder einem betroffenen Zug; der Beleg ist je eine Zählung. Die zwei Nachbau-Reste der Runde 54 (T74, T70) sind seit Runde 55 erledigt.
...
- [ ] **T79 · Ogerpon trägt seinen festen Tera-Typ und seine Maske** (Sets und Spreads, Mini-Runde, klein, score-berührend D3)
  ...
  Hinweis: Der Bau setzt `teraType` heute nur aus dem Log (`packages/replay-core/src/team-builder.ts:212`); Rückfall auf `species.requiredTeraType`, ebenso das Item auf `species.requiredItem`. Erster Schritt: zählen, wie viele Bank-Stellungen ein Ogerpon oder Terapagos tragen.
