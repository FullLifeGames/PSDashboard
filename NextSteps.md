...
- **Iterationen** bündeln die TODOs einer Sitzung. Eine Iteration wird beim Start zur Runde mit der nächsten freien Rundennummer: Iteration 1 war Runde 46, Iteration 2 war Runde 47, Iteration 2a war Runde 48, Iteration 2b war Runde 49, Iteration 3 war Runde 50, Iteration 4 war Runde 51, Iteration 4a war Runde 52, Iteration 4d war Runde 53, Iteration 4b war Runde 54, Iteration 4e war Runde 55, Iteration 4c war Runde 56. Score-berührende TODOs derselben Iteration bekommen je ihre eigene Messung (D3), nie eine gemeinsame.
- **T-Nummern** (T01 bis T45) sind feste Namen, vergeben am 18.09. in Prioritäts-Reihenfolge. Wandert ein TODO in der Liste, behält es seine Nummer; ein neues TODO bekommt die nächste freie (ab T81; T46 kam am 18.09. in Runde 46 dazu, T47 bis T51 in Runde 47, T52 und T53 in Runde 48, T54 in Runde 49, T55 in Runde 50, T56 bis T64 in Runde 51, T65 am 19.09. nach deren Gate, T66 bis T68 am 20.09. in Runde 52, T69 am 20.09. in Runde 53, T70 bis T74 am 21.09. in Runde 54, T75 am 21.09. in Runde 55, T76 am 23.09. am Gate der Runde 56, T77 bis T80 am 23.09. in Runde 56). „braucht T01“ heißt: T01 muss vorher gelaufen sein.
...
- [ ] **T58 · Doubles bekommt den Zellenplan: Klassen und K.-o.-Quoten für Paar-Züge** (Zufall preisen, Runde, groß, score-berührend D3)
  ...
  *Erfolg:* Die vier Doubles-Dumps tragen `koOdds`, die gespielte Zelle in 2634199230 Zug 5 preist den K. o. an Incineroar anteilig statt gar nicht, Singles-Dumps und Singles-Zeilen der Bank bleiben ziffern-gleich, die Doubles-Zeilen der Bank stehen in der vorregistrierten Linie, Doubles-Matrixzeit höchstens im vorregistrierten Rahmen. *Plan T58:* 8 Schritte, 3 offene Entscheidungen.
  ...
  - [x] **7.** Gate D3 (Korrektur mit eigenem Beleg): Sonden (Zellen-Fehler, Anker, Matrixzeit verschränkt), Bank gepaart gegen `r56-base`, drei Feedback-Läufe, Tier-Zählung mit gelesenen Doubles-Urteilen, Suite, e2e, lint, `tsc -b`, `pack:smoke`. Ergebnis 23.09. (`docs/perf/probes/2026-09-23-r56/`): Kanten-Zellen 0,021 neben 64 Seeds (vorher 0,062, Schwelle 0,030), p90 0,053; 247 Zellen ohne Ereignis ziffern-gleich; 4,55 Ziehungen je Plan- oder Rückfall-Zelle; Rückfall 27 %; Anker −0,143 gegen −0,125 (vorher −0,652); Matrixzeit 3,72× und 3,46× in zwei Läufen (Schwelle 4×); Bank „no gain resolved; no harm“, eine Warnung (hq Doubles spät +15 bp, davon 10 aus 912883 Zug 10), Singles 585 von 585 Zeilen byte-gleich; Feedback dreimal byte-gleich, Singles-Dumps unbewegt, Doubles-Tiers 12/5/0 → 9/3/0 auf 10 bewegten Zügen; Suite, e2e 75 von 75, lint, `tsc -b`, `pack:smoke`.
...
Am User-Gate vom 21.09. („3b“) aus Iteration 14 direkt hinter den Doubles-Zellenplan gezogen. Der Schiedsrichter aus Runde 54 liegt fertig da und misst jeden Commit in 167 s. Das TODO gehört zur Statik der Bedrohung, nicht zum Endspiel-Löser.

- [ ] **T73 · Züge und Fähigkeiten, die den Zug-Typ ändern** (Endspiel, Runde, mittel, score-berührend D3)

  smogtours-gen9doublesou-937926 Zug 2: Primarina mit Liquid Voice klickt Hyper Voice in einen Sneasler mit Tera Geist. Die Statik liest den Zug als Normal und setzt den Schaden auf 0; im Spiel ist es ein Wasser-Zug, der Schadensrechner liest 71 bis 84 % der KP. Das ist die letzte falsche Immunität der Bank nach Runde 54 (vorher 50). Zur selben Familie gehören Pixilate, Aerilate, Refrigerate, Galvanize und Normalize, dazu Züge, deren Typ erst beim Einsatz feststeht: Tera Blast (Typ und Kategorie folgen dem Tera; 4 Klicks in den 129 Bank-Replays), Weather Ball, Terrain Pulse, Judgment, Multi-Attack, Revelation Dance, Ivy Cudgel.

  Hinweis: Erst zählen: Wie viele Bank-Stellungen tragen einen solchen Träger auf dem Feld? Beleg ist der Schiedsrichter aus Runde 54 (`docs/perf/probes/2026-09-20-r54/T57/probes/`, ein Befehl je Commit). Jeder neue Live-Zugriff in `score/threat.ts` braucht seinen Schlüssel-Term (Wetter und Feld für Weather Ball und Terrain Pulse). Adaptability und der 60-BP-Boden der Tera-Züge gehören in dieselbe Sichtung. Der Null-Zug-Satz schweigt seit Runde 54 bei elf dieser Züge; Hidden Power fehlt dort noch (Gen 2 bis 7 führen den nackten Namen `hiddenpower` mit Dex-Typ Normal, ein Hidden Power gegen einen Geist liest der Satz als wirkungslos).

  *Erfolg:* Falsche Immunitäten auf den Bank-Stellungen 1 auf 0, der Abstand zum Schadensrechner fällt auf den Paaren mit Träger, keine gepoolte Bank-Zeile zeigt Schaden. *Plan T73:* 6 Schritte, 2 offene Entscheidungen.

## Iteration 4g · Paar-Plan: Deckung, Fake Out und der Doubles-Baum

Zwei Reste aus Runde 56, gefunden beim Lesen der bewegten Doubles-Urteile (`docs/perf/probes/2026-09-23-r56/reading/reading.md`). Beide fassen den Paar-Plan an; die Zählungs-Sonde der Runde (`census-after.vt.ts`, 50 s) und die verschränkte Zeitmessung (`timing-ab.vt.ts`, 10 min) liegen fertig da.
...
- [ ] **T77 · Paar-Plan: seltene teure Ausgänge und das sichere Zurückzucken von Fake Out** (Zufall preisen, Mini-Runde, klein, score-berührend D3)
  ...
  smogtours-gen9doublesou-912045 Zug 8: Der Paar-Plan hört bei 95 % Deckung auf und lässt in der gespielten Zelle eine Klasse weg, in der ein Volltreffer tötet (Wahrscheinlichkeit 3,4 %, Wert −0,86). Die fehlende Masse verteilt er auf die gefundenen Klassen, als gäbe es den tödlichen Volltreffer nicht. Dasselbe passiert einem einzelnen 5-%-Fehlschlag (2663093831 Zug 3, neun Zellen mit Steam Eruption). Zweitens lässt Fake Out sicher zurückzucken, Regel F3 zählt die `cant`-Zeile aber als Zufall und schickt die Zelle auf das Mittel von acht Ziehungen: 13 der 25 `cant:flinch`-Rückfälle der Zählung sind Fake Out allein. Wie ein Wetterbericht, der den Hagel weglässt, weil der Rest schon 95 % des Tages abdeckt.

  Hinweis: Fake Out: Eine `cant:flinch`-Zeile zählt nur als Zufall, wenn ein Treffer mit Zuck-Chance unter 100 % das Ziel traf (dieselbe Regel liest `flinchChance` in `pair/pattern.ts` schon). Deckung: weiterziehen, solange ein Kandidat mit mindestens 0,02 Masse übrig ist und das Budget reicht, oder die Schwelle auf 0,98 heben; beides gegen Kantenfehler und Zeit messen (heute 0,021 und 3,5 bis 3,7×, Rahmen 4×).

  *Erfolg:* Kantenfehler der Zählung höchstens 0,021 und p99 unter 0,18, weniger `cant:flinch`-Rückfälle, Matrixzeit weiter unter 4×, Singles unberührt. *Plan T77:* 4 Schritte, 1 offene Entscheidung.

- [ ] **T78 · Der Doubles-Baum kennt die Klassen des Paar-Plans nicht** (Zufall preisen, Runde, mittel, score-berührend D3)

  VGC 2629703929 Zug 13: Koraidon (53 %) steht allein gegen ein volles Solgaleo. Flare Blitz tötet Solgaleo laut den K.-o.-Angaben der Engine in 58 % der Würfe; trotzdem liest der Baum den letzten Zug als entschieden für p2, und die Flare-Blitz-Zellen stehen bei −0,2 bis −0,92. Der Paar-Plan erreicht Züge, die über MCTS laufen, nur in den Verify-Zellen, und welche Zellen der Baum zur Prüfung meldet, entscheidet noch `planCellEvents`, das in Doubles immer aufgibt (Komma in der Wahl, oder Slot a ist gefallen). Zweitens tragen Doubles-Bäume keine Klassen-Schlüssel: Eine Verify-Mischung schneidet den Baum heraus und vertieft nur ihre erste Ziehung. In 912045 Zug 8 verschwindet so eine Ungenauigkeit, die bei richtiger Preisung stehen bliebe. Wie ein Prüfer, der nur die Rechnungen nachrechnet, die ihm ein Kollege vorlegt, und aus der Doppel-Abteilung kommt nie eine.

  Hinweis: Randzellen-Meldung (`boundaryCells`) und Klassen-Schlüssel der Bäume (`rootClassKeys`) können aus dem Paar-Plan kommen (`readPattern` auf der Baum-Ziehung). Die Vertiefung nur der ersten Ziehung ist die Familie von T16. Die Bank rechnet 119 der 248 Doubles-Stellungen über MCTS; dort liegt der Hebel.

  *Erfolg:* 2629703929 Zug 13 liest nicht mehr entschieden, die Flare-Blitz-Zellen stehen bei ihren K.-o.-Angaben, 912045 Zug 8 trägt seine Ungenauigkeit wieder oder das Gate nennt den Grund, die Doubles-Zeilen der Bank bleiben in der vorregistrierten Linie, Singles unberührt. *Plan T78:* 5 Schritte, 2 offene Entscheidungen.

## Iteration 5 · Wurzel: Klassen auf Ansage und Speed-Ties

Alle drei fassen `search/cell-sampler.ts` an: eine Spec, drei getrennt gemessene Commits. T65 ist der kleinste und kam am 19.09. nach dem Gate der Runde 51 dazu. Der Play-out-Pin läuft zuerst einzeln (D7). In Doubles läuft seit Runde 56 der Paar-Plan (`pair/`); seine Rückfall-Regeln F2 (Gleichstand) und F3 (Zurückzucken) sind die Doubles-Hälfte von T15, T24 und T65, und die Würfel dort antworten schon auf Ansage.
...
Sechs kleine Punkte mit einem gemeinsamen Schluss-Gate, fünf davon render-only; T59 und T64 kamen in Runde 51 dazu, T69 in Runde 53. Prosa ist nur an drei Stellen byte-gepinnt (`summaryIncludes` für 573756 t8, 573756 t73, 562428 t10); die Golden 655336 pinnt keine Prosa.
...
- [ ] **T79 · Ogerpon terastallisiert in seinen festen Typ** (Sets, Mini-Runde, klein, score-berührend D3)

  smogtours-gen9doublesou-912045: Ogerpon-Cornerstone kann nur zu Gestein terastallisieren. Das Log zeigt keinen Tera-Typ, der Bau lässt das Feld leer, und der Simulator nimmt dann den ersten Typ der Art: Pflanze (`pokemon.js:209`: `set.teraType || types[0]`). Die Engine rechnet Tera-Klicks dieses Ogerpon also mit dem falschen Typ; eine Zelle, die p2s Urteil in Zug 1 mitträgt, preist einen K.-o.-Anteil auf Tera Pflanze. Der Dex kennt den festen Typ (`requiredTeraType`: Wellspring Wasser, Hearthflame Feuer, Cornerstone Gestein, Terapagos Stellar), nur der Team-Validator liest ihn. Wie ein Formular mit vorgedrucktem Feld, in das jemand trotzdem etwas anderes schreibt.

  Hinweis: Der Bau setzt `teraType` heute nur aus dem Log (`packages/replay-core/src/team-builder.ts:212`); Rückfall auf `species.requiredTeraType`. Erster Schritt: zählen, wie viele Bank-Stellungen ein Ogerpon oder Terapagos tragen.

  *Erfolg:* Jeder gebaute Ogerpon und Terapagos trägt seinen festen Tera-Typ, die Tera-Zählung aus Runde 54 bleibt bei 0 Abweichungen, Bank und Dumps bewegen sich nur in Spielen mit diesen Arten. *Plan T79:* 3 Schritte, keine offene Entscheidung.

- [ ] **T80 · Items, die das Protokoll ausschließt** (Sets, Mini-Runde, klein, score-berührend D3)
...
Drei Kandidaten, die Runde 47 gemessen und nicht übernommen hat, dazu T52 aus Runde 48 und T71 aus Runde 54 (die geparkte STAB-Regel). Das Verdikt mit Bändern (T47) liegt seit Runde 48 vor. Sie stehen hinter den Fitter-Runden, weil deren Kontroll-Aufnahme die Gewichte ohnehin neu liest.
...
- [ ] Doubles-Urteile springen zwischen zwei Zuständen einer Runde (Runde 54, VGC 2629703929): Mit dem lebenden Verteidiger-Typ entsteht in Zug 11 ein Blunder (Reue 0,00 auf 0,51), mit der STAB-Regel verschwindet er wieder (0,01), und in Zug 9 entsteht ein anderer (0,12 auf 0,48). Jede Doubles-Wurzelzelle ist eine Ziehung (T58) → nach T58 dieselben vier Spiele neu lesen; springen die Urteile dann immer noch, ist es nicht der Zellenplan.
- [ ] Warnung der Runde 54 auf der Bank: Doubles Mitte hq +96 bp [+8, +198] auf 49 Stellungen (mit der STAB-Regel +98 [+11, +196]); drei Stellungen tragen 92 davon (smogtours-gen9doublesou-937928 Zug 6, -913993 Zug 6, -939625 Zug 8, alle lesen nach der Korrektur freundlicher für den späteren Verlierer) → bei der nächsten Doubles-Runde (T58, T31) diese drei Stellungen zuerst lesen.
...
- **D1** Kein Push ohne Ansage (Stand 21.09. nach Runde 54: master liegt 93 Commits vor origin/master; origin/master steht auf ba2ce5b, Release 0.7.1). Seit dem 20.09. trägt der Branch `v1` bei origin den master-Stand: nach Runde 52 (User-Freigabe 14:50: „auf einen v1 branch, den du pushen darfst“) nach Runde 53 (User-Gate 16:22, „3a“) und nach Runde 54 (User-Gate 21.09. 16:21, „4a“). Jede Freigabe gilt für `v1` und für diesen einen Stand; master selbst bleibt ungepusht.
...
- **D16** `ALIGNMENT_SEEDS[0]` bleibt `'1,2,3,4'`; jede Listen-Änderung ist ein Cache-Version-Event. Runde 49 hat v48 genommen (Merkzettel-Schlüssel), Runde 53 v49 (Übergabe der Tempo-Vorlösung), Runde 54 v50 (Tera im Nachbau und in der Statik), Runde 55 v51 (Encore und gesperrte Slots im Nachbau), Runde 56 v52 (Doubles-Zellenplan); `r45-threshold` trägt eine v47 und bekäme bei einer Landung die nächste freie Nummer.
