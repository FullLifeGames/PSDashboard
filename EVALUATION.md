...
Solved spreads flow into every simulator team and show in the stats panel as "fits observed damage", so branches stop KOing Pokémon that survived the same hit in the replay.
